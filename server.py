...
_CHECKLIST_BY_TASK = {
    "commissioning": [
        ...
        {"id": "com_3", "text": "All protective devices set to correct ratings per design.", "critical": True},
        {"id": "com_4", "text": "ERMS activated on the incomer — confirmed before first energization begins.", "critical": True},
        {"id": "com_5", "text": "First energization plan communicated to all team members before starting.", "critical": False},
    ],
    "operation": [
        {"id": "op_1", "text": "Correct panel identified — label matches the scanned panel in the app.", "critical": True},
        {"id": "op_2", "text": "Work permit obtained and signed by supervisor.", "critical": True},
        {"id": "op_3", "text": "ERMS status confirmed with site supervisor before any switching operation.", "critical": True},
        {"id": "op_4", "text": "All personnel in the electrical room informed before switching begins.", "critical": False},
    ],
    "service": [
        {"id": "svc_1", "text": "Service work order obtained and scope confirmed with supervisor.", "critical": True},
        {"id": "svc_2", "text": "ERMS activated on the incomer before opening panel doors.", "critical": True},
        {"id": "svc_3", "text": "All tools verified as insulated — no bare metal tools permitted near live parts.", "critical": True},
        {"id": "svc_4", "text": "Safety observer assigned and briefed on emergency procedure and first aid location.", "critical": True},
        {"id": "svc_5", "text": "⚠ ERMS only protects load side of incomer — supply cables remain live.", "critical": False},
    ],
    "modification": [
        {"id": "mod_1", "text": "Change permit / work order signed — supervisor informed of live adjacent sections.", "critical": True},
        {"id": "mod_2", "text": "Adjacent busbars confirmed live — insulating barriers prepared and ready before entry.", "critical": True},
        {"id": "mod_3", "text": "New cables pre-cut and pre-terminated before approaching the busbar area.", "critical": True},
        {"id": "mod_4", "text": "Spare slot confirmed empty and busbar capacity verified.", "critical": True},
        {"id": "mod_5", "text": "Magnetic parts tray in place — prevents screw and washer drops onto live busbars.", "critical": False},
        {"id": "mod_6", "text": "⚠ ERMS only protects load side of incomer — supply cables remain live.", "critical": False},
    ],
    "replacement": [
        {"id": "rep_1", "text": "Replacement breaker verified — correct type, current rating, and voltage matches original exactly.", "critical": True},
        {"id": "rep_2", "text": "Adjacent busbars may be live — insulating barriers prepared before entry.", "critical": True},
        {"id": "rep_3", "text": "Phase sequence labels checked — polarity verified before installation.", "critical": True},
        {"id": "rep_4", "text": "Torque values confirmed from manufacturer datasheet.", "critical": False},
        {"id": "rep_5", "text": "Safe disposal method for old breaker confirmed — not left inside the panel.", "critical": False},
    ],
    "others": [
        {"id": "oth_1", "text": "Work scope clearly defined and approved by supervisor before entering electrical room.", "critical": True},
        {"id": "oth_2", "text": "Proximity to switchboard assessed — ERMS requirement confirmed with supervisor.", "critical": True},
        {"id": "oth_3", "text": "All personnel in the area informed of the work and the electrical hazard zone.", "critical": False},
    ],
}
